        ...
        <section class="section__login">
          ...
          <form method="post" name="loginform">
            ...
            <div class="login__btn__wrapper">
              ...
              <a
                class="btn btn-katok"
                href="https://kauth.kakao.com/oauth/authorize?client_id=9cbaf3231e03e46ca8f9be8ce62f4866&redirect_uri=http://localhost:3000/nukacola/kakaologin.me&response_type=code"
              ></a>
            </div>
          </form>
        </section>
