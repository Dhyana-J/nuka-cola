...
<script defer>
	...
	if(${cnPi.currentPage}==${cnPi.maxPage}) stopLoad=false;
	...
	window.addEventListener('scroll',()=>{
	  if(window.pageYOffset + document.documentElement.clientHeight >
	    ...
	    console.log('로드!')
	    axios.get('loadConnectionList.us', {
	      params: {
	    ...
	    .then(function(loadedInfo){
	    	...
	    	let list = loadedInfo.data.connection;
	    	let area = document.querySelector('.connection-list');
	    	console.log('list출력');
	    	console.log(list);
	    	console.log('area출력');
	    	console.log(area);
